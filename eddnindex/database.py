...
class DBConnection(object):
    ...
    def open(self, config: DatabaseConfig):
        self.streaming_cursor_args = []
        self.streaming_cursor_kwargs = {}
        self.prepared_cursor_args = []
        self.prepared_cursor_kwargs = {}
        self.connection_type = config.ConnectionType

        if config.ConnectionType == 'mysql.connector':
            ...
            self.dialect = 'mysql'
        elif config.ConnectionType == 'mysqlclient':
            import MySQLdb
            ...
            self.dialect = 'mysql'
        elif config.ConnectionType == 'pymysql':
            import pymysql
            ...
            self.dialect = 'mysql'
        elif config.ConnectionType == 'psycopg2':
            import psycopg2
            ...
            self.dialect = 'pgsql'
        elif config.ConnectionType == 'pymssql':
            import pymssql
            ...
            self.dialect = 'mssql'
        elif config.ConnectionType == 'sqlite3':
            import sqlite3
